package com.example.bookshop01.admin.order.controller;
...
import com.example.bookshop01.admin.order.service.AdminOrderService;
...
public class AdminOrderControllerImpl extends BaseController  implements AdminOrderController{
	...
	public ResponseEntity<String> modifyDeliveryState(@RequestParam Map<String, Object> deliveryMap, 
			                        HttpServletRequest request, HttpServletResponse response)  throws Exception {
	...
	public ModelAndView orderDetail(@RequestParam("order_id") int order_id, 
		...
		String viewName=(String)request.getAttribute("viewName");
		ModelAndView mav = new ModelAndView(viewName);
		Map<String, Object> orderMap =adminOrderService.orderDetail(order_id);
