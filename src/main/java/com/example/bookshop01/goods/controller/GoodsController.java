...
public interface GoodsController  {
	...
	public @ResponseBody Map<String, List<String>> keywordSearch(@RequestParam("keyword") String keyword,HttpServletRequest request, HttpServletResponse response) throws Exception;
