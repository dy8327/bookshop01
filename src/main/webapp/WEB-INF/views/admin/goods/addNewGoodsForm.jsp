...
<script type="text/javascript">
  ...
  function fn_add_new_goods(obj){
    ...
    var rateInput = document.getElementById("discount_rate");
    var salesPriceInput = document.getElementById("goods_sales_price");
    ...
    var salesPrice = Math.floor(price * (100 - rate) / 100);
	...
	<div class="tab_container" id="container">
		...
		<div class="tab_container">
			...
			<tr>
				<td>제품정가</td>
				<td>
					<input id="goods_price" name="goods_price" type="text" size="40"
						onkeyup="calcSalesPrice()" />
				</td>
			</tr>
			...
			<tr>
				<td>할인율</td>
				<td>
					<select id="discount_rate" onchange="calcSalesPrice()">
			...
			<tr>
				<td>최종판매가격</td>
				<td>
					<input id="goods_sales_price" name="goods_sales_price" type="text" size="40" readonly />
				</td>
			</tr>
