	...
	<div id="detail_table">
		<table>
			<tbody>
				...
				<td class="active">
					<span>
						<fmt:formatNumber value="${goods.goods_sales_price}" type="number" var="sales_price" />
						${sales_price}원

						<c:if test="${goods.goods_price > 0 && goods.goods_price > goods.goods_sales_price}">
							<c:set var="discountRate"
								value="${(goods.goods_price - goods.goods_sales_price) * 100 / goods.goods_price}" />
							(
